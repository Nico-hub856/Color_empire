...
while game:
        ...
        while start:
            ...
            if party_num > 1 and players > 1:
                if score_memo1 > score_memo2:
                    draw_text("PLAYER 1 WINS!", font ,70, RED,WIDTH/2 , 180 - 40)
                elif score_memo1 < score_memo2:
                    draw_text("PLAYER 2 WINS!", font ,70, GREEN2,WIDTH/2 , 180 - 40)
                elif score_memo1 == score_memo2:
                    draw_text("EQUALITY!", font ,70, BLACK,WIDTH/2 , 180 - 40)
                if select == 1:
                    draw_text("> Replay <", font ,70, BLACK,WIDTH/2 , HEIGHT / 2 - 40)
                    draw_text("Quit", font ,70, BLACK,WIDTH/2 , HEIGHT / 2 + 40)
            ...
            if select == 1:
                ...
                if party_num > 1:
                    ...
                    draw_text("> Play <", font ,70, BLACK,WIDTH/2 , HEIGHT / 2 - 40)
                draw_text("Quit", font ,70, BLACK,WIDTH/2 , HEIGHT / 2 + 40)
                try:
    ...
    def choose_screen():
        ...
        while choose:
            ...
            if last_click <= 0:
                if select == 1:
                    draw_text("Number of players...", font ,70, BLACK,WIDTH/2 , 180 - 40)
                    draw_text("> 1 player <", font ,70, BLACK,WIDTH/2 , HEIGHT / 2 - 40)
                    draw_text("2 player", font ,70, BLACK,WIDTH/2 , HEIGHT / 2 + 40)
                    try:
                        if joystick0.get_button(1)==1:
                            if nb_joysticks >= 1:
                                choose = False
    ...
    while running:
        ...
        if players == 1:
            ...
            draw_cursor(x_pos, y_pos)
        if players == 2:
            draw_text(str(score1), font ,120, (255, 0, 0),240, HEIGHT - 150)            
            draw_text(str(score2), font ,120, (0, 100, 0),WIDTH - 240, HEIGHT - 150)
        else:
            draw_text(str(score1), font ,120, (255, 0, 0),WIDTH / 2, 44)
        if round_time >= 0:
            draw_text(str(round_time), font ,120, (0, 0, 0),WIDTH/2 , HEIGHT - 150)
        elif round_time <= 0:
            draw_text("GAME OVER", font ,120, BLACK,WIDTH/2 , HEIGHT - 150)
